        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div class="sidebar-brand-icon">
                    <img src="https://sktbcirebon.files.wordpress.com/2017/08/logo-yayasan.png" width="50"
                        height="50">
                </div>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="cards.html">Data Karyawan</a>
                        <a class="collapse-item" href="{{ route('nilai.index') }}">Data Nilai</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Isi Menu:</h6>
                        <a class="collapse-item" href="{{ route('mapel.index') }}">Data Mata Pelajaran</a>
                        <a class="collapse-item" href="utilities-border.html">Menu 2.2</a>
                        <a class="collapse-item" href="utilities-animation.html">Menu 3.2</a>
                    </div>
                </div>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="{{ Auth::user()->logout }}" data-toggle="modal"
