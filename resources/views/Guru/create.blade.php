		 ...
		 <!-- Bagian Pembuka Isi Conten Template -->
          ...
          <center><input type="submit" class="btn btn-primary btn-user btn-block" id="btn_login" value="Sig In" /></center>
            ...
            <div class="col-lg-8 mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary" align="center">DATA GURU</h6>
                </div>
                <div class="card-body">
				
                    <form class="user" method="POST" action="{{ route('guru.store') }}">
                    ...
                    <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="nm_guru" placeholder="Masukkan Nama..">
                    </div>
